...
public class Pessoa {
     ...
     * Construtores
     * 
     * Utilizamos o método u para inicializar nossas classes,
     * funcionando com uma configuração pré via da mesma.
     * 
    ...
    // Construtor padrão
    // Todo método construtor possui o emsmo nome da classe
    public Pessoa() {
